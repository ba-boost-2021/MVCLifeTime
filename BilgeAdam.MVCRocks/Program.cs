...
//launchSettings.json içerisindeki "ASPNETCORE_ENVIRONMENT" deðeri þu an çalýþtýðýnýz ortamı belirler
...
builder.Services.Configure<Settings>(settingSection); // DI üzerinden Setting'e erişebilmek için yazıldı
